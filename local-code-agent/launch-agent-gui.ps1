# Local Code Agent GUI - launcher for PowerShell
# Run: .\launch-agent-gui.ps1
# Or:  .\launch-agent-gui.ps1 -ProjectPath "C:\path\to\my-project"
...
$innerCommand = "& '$ActivateScript'; Set-Location '$ProjectPath'; local-agent-gui"
