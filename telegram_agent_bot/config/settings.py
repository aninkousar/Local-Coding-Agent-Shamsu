...
class Settings(BaseModel):
    ...
    # Voice message transcription (faster-whisper, fully local - see
    # bot/services/transcription.py). Rejecting anything longer than
    # voice_max_duration_seconds happens BEFORE download/transcription -
    # a long ramble transcribed as one prompt is rarely what's wanted, and
    # CPU transcription of long audio is slow.
    ...
    def load(cls) -> "Settings":
        ...
        return cls(
            ...
            voice_max_duration_seconds=float(os.environ.get("VOICE_MAX_DURATION_SECONDS", "120.0")),
